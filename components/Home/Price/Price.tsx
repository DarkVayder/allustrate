  ...
  return (
    <div className='pt-16 pb-16 bg-gray-950'>
      <div className='w-[80%] mx-auto grid grid-cols-1 xl:grid-cols-2 gap-10 items-center'>
        <div className=''>
          <h1 className='uppercase text-white mb-6 font-bold'>Flexible and affordable</h1>
          <h1 className='text-3xl md:text-4xl lg:text-6xl font-bold mb-6 text-white'>Our Pricing Plans</h1>
          <p className='text-white font-medium text-opacity-70'>Choose the perfect plan for your needs. Affordable pricing with flexible options to bring your ideas to life</p>
          <div className='mt-8'>
